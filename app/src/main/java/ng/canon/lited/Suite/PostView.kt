...
class PostView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        display_url = intentID.getString("displayurl")
        post_likes = intentID.getString("like_counts")
        post_caption = intentID.getString("caption")
        userid =  intentID.getString("owner_id")
        isVideo =  intentID.getBoolean("isVideo")
        progressBox = ProgressDialog(this@PostView)
        ...
        if (isVideo){
            ...
            toolbarx.title = getString(R.string.is_photo)
        ...
        observable!!.subscribeOn(Schedulers.io())
                ...
                .subscribe(object : Observer<String> {
                    ...
                    override fun onComplete() {
                        ...
                        GlideApp.with(applicationContext).setDefaultRequestOptions(requestOptions).load(display_url).into(cover)
    ...
    fun showDialog(postId:String,useID:String,usename:String){
        ...
        BottomSheet.Builder(this@PostView)
    ...
    fun permissionDialog(){
        ...
        runOnUiThread {
            FancyGifDialog.Builder(this@PostView)
                    ...
                    .OnNegativeClicked(object : FancyGifDialogListener {
                        override fun OnClick() {
                            ...
                            Toast.makeText(this@PostView,""+getString(R.string.permissionMessage),Toast.LENGTH_LONG).show()
                            finish()
