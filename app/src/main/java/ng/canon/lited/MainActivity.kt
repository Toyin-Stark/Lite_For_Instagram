...
import ng.canon.lited.Tabs.*

class MainActivity : AppCompatActivity() {
    private val tabIcons = intArrayOf(R.drawable.ic_instagram,R.drawable.ic_explore,R.drawable.ic_search,R.drawable.ic_file_download)
    ...
    fun loadNavigation(){
        ...
        val home = AHBottomNavigationItem(R.string.gram_tab,   R.drawable.ic_instagram,android.R.color.tertiary_text_light)
        val explore = AHBottomNavigationItem(R.string.explore_tab, R.drawable.ic_explore,android.R.color.tertiary_text_light)
        val search = AHBottomNavigationItem(R.string.find_tab,   R.drawable.ic_search,android.R.color.tertiary_text_light)
        val save = AHBottomNavigationItem(R.string.save_tab,   R.drawable.ic_file_download,android.R.color.tertiary_text_light)
        ...
        bottomNavigation.setOnTabSelectedListener(object:AHBottomNavigation.OnTabSelectedListener{
            override fun onTabSelected(position: Int, wasSelected: Boolean): Boolean {
                ...
                if (position == 2){
                    ...
                    val savepale = PhotoBucket()
                    val savetransaction = supportFragmentManager.beginTransaction()
                    savetransaction.replace(R.id.frames, savepale)
